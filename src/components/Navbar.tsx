...
//                     minutes—hold more, win more. Get a chance to win the
...
//                         it all (higher holdings = higher win %) *LPs excluded
//                       </div>
//                     </div>
//                     <div>
    ...
    <>
      ...
      {modalType && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
          ...
          {/* 
            Reduced max-h on mobile to 75vh, 
            then up to 80vh on md screens.
            Also added pb-16 for bottom padding.
          */}
          <div
            className={`
              relative flex flex-col w-full mx-4
